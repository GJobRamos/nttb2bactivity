...
public class TmaAddressRequest {
    ...
    private TmaCountryRequest country;
    ...
    private TmaRegionRequest region;
    ...
    public TmaCountryRequest getCountry() {
        return country;
    }

    public void setCountry(TmaCountryRequest country) {
    ...
    public TmaRegionRequest getRegion() {
        return region;
    }

    public void setRegion(TmaRegionRequest region) {
        this.region = region;
    }
    ...
    public void setRiskArea(boolean riskArea) {
