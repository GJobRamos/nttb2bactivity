 ...
 */
package br.com.ntt.b2b.fulfilmentprocess.actions.order;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(Nttb2bFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimitExternal"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(Nttb2bFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreToleranceExternal"));
