 ...
 */
package br.com.ntt.b2b.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, Nttb2bFulfilmentProcessConstants.PARENT_PROCESS);
