 ...
 */
package br.com.ntt.b2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Nttb2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Nttb2bFulfilmentProcessConstants.PARENT_PROCESS);
