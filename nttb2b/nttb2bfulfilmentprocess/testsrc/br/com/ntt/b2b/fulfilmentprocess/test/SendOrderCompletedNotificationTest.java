...
import br.com.ntt.b2b.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction;
...
public class SendOrderCompletedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link br.com.ntt.b2b.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
