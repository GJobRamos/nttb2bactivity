...
/**
 * Global class for all Nttb2bwebservices constants. You can add global constants for your extension into this class.
 */
@SuppressWarnings({"deprecation","squid:CallToDeprecatedMethod"})
public final class Nttb2bwebservicesConstants extends GeneratedNttb2bwebservicesConstants
{
	public static final String EXTENSIONNAME = "nttb2bwebservices";
	...
	public static final String HOST = "nttb2bwebservices.host";
	public static final String HOST_DEFAULT = "hostname";

	private Nttb2bwebservicesConstants()
	{
