 ...
 */
package br.com.ntt.b2b.test.setup;
...
import br.com.ntt.b2b.test.constants.Nttb2bTestConstants;
import br.com.ntt.b2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Nttb2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/nttb2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/nttb2btest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/nttb2btest/import/cstickets.impex");
			...
			importImpexFile(context, "/nttb2btest/import/csquotes.impex");
		}
	}
}
