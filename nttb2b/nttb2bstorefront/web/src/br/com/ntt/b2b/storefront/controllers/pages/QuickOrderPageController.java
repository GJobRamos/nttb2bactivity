 ...
 */
package br.com.ntt.b2b.storefront.controllers.pages;
...
import br.com.ntt.b2b.storefront.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException // NOSONAR
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("nttb2bstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("nttb2bstorefront.quick.order.rows.max", 25)));
